...
namespace KhanAcademy.Common
{
    ...
    public class LayoutAwarePage : Page
    {
		...
		protected virtual void DataRequested(DataTransferManager sender, DataRequestedEventArgs args)
		{
			args.Request.FailWithDisplayText("To share a video, go to the video player page and then try to share.");
		}
